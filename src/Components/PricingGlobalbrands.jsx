...
const PricingGlobalbrands = () => {
    ...
    return (
        <div className='global-brand' style={{backgroundColor: '#e2f1ff', marginTop: '0'}}>
            <h1 className="pricingglobal-heading" style={{fontSize: '1.5rem', fontWeight: '500', opacity: '.75', fontFamily: 'Poppins, sans-serif'}}>Trusted By Over 500+ Companies Worldwide</h1>
...
export default PricingGlobalbrands
